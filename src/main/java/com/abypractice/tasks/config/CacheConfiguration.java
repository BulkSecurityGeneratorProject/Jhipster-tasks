package com.abypractice.tasks.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("aymenTasks");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("aymenTasks");
        ...
        config.getMapConfigs().put("com.abypractice.tasks.domain.*", initializeDomainMapConfig(jHipsterProperties));
